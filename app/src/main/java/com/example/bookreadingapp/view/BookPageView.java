package com.example.bookreadingapp.view;
...
public class BookPageView extends RelativeLayout {
    ...
    com.example.bookreadingapp.view.BookPageBezierHelper mBookPageBezierHelper;
...
//        canvas.clipPath(mCurrentPagePath, Region.Op.XOR);
    ...
    public void setBookPageBezierHelper(com.example.bookreadingapp.view.BookPageBezierHelper bookPageBezierHelper) {
